...
from sandboxpilot.errors import NetworkProxyError
...
_STRIP_REQUEST_HEADERS = HOP_BY_HOP | {"host", "content-length", "authorization"}
_STRIP_RESPONSE_HEADERS = HOP_BY_HOP | {"content-length", "content-encoding"}
